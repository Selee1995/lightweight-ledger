...
.method public delete(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .line 196
    invoke-virtual {p0, p1}, Landroid/arch/persistence/db/framework/FrameworkSQLiteDatabase;->compileStatement(Ljava/lang/String;)Landroid/arch/persistence/db/SupportSQLiteStatement;

    move-result-object p1

    .line 197
    invoke-static {p1, p3}, Landroid/arch/persistence/db/SimpleSQLiteQuery;->bind(Landroid/arch/persistence/db/SupportSQLiteProgram;[Ljava/lang/Object;)V

    .line 198
    invoke-interface {p1}, Landroid/arch/persistence/db/SupportSQLiteStatement;->executeUpdateDelete()I
...
.method public query(Landroid/arch/persistence/db/SupportSQLiteQuery;)Landroid/database/Cursor;
    ...
    sget-object v2, Landroid/arch/persistence/db/framework/FrameworkSQLiteDatabase;->EMPTY_STRING_ARRAY:[Ljava/lang/String;
...
.method public query(Landroid/arch/persistence/db/SupportSQLiteQuery;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    new-instance v1, Landroid/arch/persistence/db/framework/FrameworkSQLiteDatabase$2;

    invoke-direct {v1, p0, p1}, Landroid/arch/persistence/db/framework/FrameworkSQLiteDatabase$2;-><init>(Landroid/arch/persistence/db/framework/FrameworkSQLiteDatabase;Landroid/arch/persistence/db/SupportSQLiteQuery;)V
...
.method public update(Ljava/lang/String;ILandroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/Object;)I
    ...
    .line 211
    sget-object v1, Landroid/arch/persistence/db/framework/FrameworkSQLiteDatabase;->CONFLICT_VALUES:[Ljava/lang/String;
    ...
    .line 236
    invoke-static {p1, v1}, Landroid/arch/persistence/db/SimpleSQLiteQuery;->bind(Landroid/arch/persistence/db/SupportSQLiteProgram;[Ljava/lang/Object;)V

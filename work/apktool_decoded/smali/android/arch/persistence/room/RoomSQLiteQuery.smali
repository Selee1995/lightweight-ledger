...
.method public bindTo(Landroid/arch/persistence/db/SupportSQLiteProgram;)V
    ...
    .line 211
    :goto_0
    iget v2, p0, Landroid/arch/persistence/room/RoomSQLiteQuery;->mArgCount:I
    ...
    invoke-interface {p1, v1, v2}, Landroid/arch/persistence/db/SupportSQLiteProgram;->bindBlob(I[B)V
    ...
    invoke-interface {p1, v1, v2}, Landroid/arch/persistence/db/SupportSQLiteProgram;->bindString(ILjava/lang/String;)V
    ...
    invoke-interface {p1, v1, v3, v4}, Landroid/arch/persistence/db/SupportSQLiteProgram;->bindDouble(ID)V
    ...
    invoke-interface {p1, v1, v3, v4}, Landroid/arch/persistence/db/SupportSQLiteProgram;->bindLong(IJ)V

    goto :goto_1

    .line 214
    :cond_4
    invoke-interface {p1, v1}, Landroid/arch/persistence/db/SupportSQLiteProgram;->bindNull(I)V

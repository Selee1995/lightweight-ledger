...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 224
    invoke-virtual {p1, p2, v2}, Landroid/support/v7/widget/TintTypedArray;->getResourceId(II)I
    ...
    invoke-virtual {p1, v0, v2}, Landroid/support/v7/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    invoke-virtual {p1, v3, v2}, Landroid/support/v7/widget/TintTypedArray;->getResourceId(II)I
    ...
    invoke-virtual {p1, v3, v2}, Landroid/support/v7/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    invoke-virtual {p1, v2}, Landroid/support/v7/widget/TintTypedArray;->getText(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v2}, Landroid/support/v7/widget/TintTypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    .line 252
    invoke-virtual {p1, v2, p3}, Landroid/support/v7/widget/TintTypedArray;->getInt(II)I
    ...
    .line 251
    invoke-static {p3, v2}, Landroid/support/design/widget/ViewUtils;->parseTintMode(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
...
.method private updatePasswordToggleView()V
    ...
    invoke-static {v3, v4, v2, v6, v0}, Landroid/support/v4/widget/TextViewCompat;->setCompoundDrawablesRelative(Landroid/widget/TextView;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method protected onLayout(ZIIII)V
    ...
    .line 1382
    iget-object p2, p0, Landroid/support/design/widget/TextInputLayout;->mTmpRect:Landroid/graphics/Rect;
    ...
    .line 1388
    invoke-virtual {v0, p1, v1, p4, p2}, Landroid/support/design/widget/CollapsingTextHelper;->setExpandedBounds(IIII)V

    .line 1394
    iget-object p2, p0, Landroid/support/design/widget/TextInputLayout;->mCollapsingTextHelper:Landroid/support/design/widget/CollapsingTextHelper;

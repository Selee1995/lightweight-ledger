...
.method private dispatchAdditions(Ljava/util/List;Landroid/support/v7/util/ListUpdateCallback;III)V
    ...
    .line 818
    invoke-static {p1, v1, v0}, Landroid/support/v7/util/DiffUtil$DiffResult;->removePostponedUpdate(Ljava/util/List;IZ)Landroid/support/v7/util/DiffUtil$PostponedUpdate;
    ...
    .line 826
    invoke-virtual {v3, v1, v2}, Landroid/support/v7/util/DiffUtil$Callback;->getChangePayload(II)Ljava/lang/Object;
...
.method private dispatchRemovals(Ljava/util/List;Landroid/support/v7/util/ListUpdateCallback;III)V
    ...
    .line 858
    invoke-static {p1, v1, v5}, Landroid/support/v7/util/DiffUtil$DiffResult;->removePostponedUpdate(Ljava/util/List;IZ)Landroid/support/v7/util/DiffUtil$PostponedUpdate;
    ...
    .line 867
    invoke-virtual {v4, v2, v1}, Landroid/support/v7/util/DiffUtil$Callback;->getChangePayload(II)Ljava/lang/Object;

    move-result-object v1

    .line 866
    invoke-interface {p2, v3, v0, v1}, Landroid/support/v7/util/ListUpdateCallback;->onChanged(IILjava/lang/Object;)V
...
.method private findMatchingItem(IIIZ)Z
    ...
    invoke-virtual {p2, v1, v0}, Landroid/support/v7/util/DiffUtil$Callback;->areItemsTheSame(II)Z
    ...
    invoke-virtual {p1, v1, v0}, Landroid/support/v7/util/DiffUtil$Callback;->areContentsTheSame(II)Z
    ...
    invoke-virtual {v1, v0, p2}, Landroid/support/v7/util/DiffUtil$Callback;->areItemsTheSame(II)Z
    ...
    invoke-virtual {p3, v0, p2}, Landroid/support/v7/util/DiffUtil$Callback;->areContentsTheSame(II)Z
    ...
    .line 692
    :cond_6
    iget v1, v2, Landroid/support/v7/util/DiffUtil$Snake;->x:I

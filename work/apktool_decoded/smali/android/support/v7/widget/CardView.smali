...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/CardView;->mShadowBounds:Landroid/graphics/Rect;

    .line 441
    new-instance v3, Landroid/support/v7/widget/CardView$1;

    invoke-direct {v3, p0}, Landroid/support/v7/widget/CardView$1;-><init>(Landroid/support/v7/widget/CardView;)V

    iput-object v3, p0, Landroid/support/v7/widget/CardView;->mCardViewDelegate:Landroid/support/v7/widget/CardViewDelegate;
    ...
    iput-boolean v2, p0, Landroid/support/v7/widget/CardView;->mCompatPadding:Z
    ...
    iput-boolean v2, p0, Landroid/support/v7/widget/CardView;->mPreventCornerOverlap:Z
    ...
    invoke-interface/range {v2 .. v8}, Landroid/support/v7/widget/CardViewImpl;->initialize(Landroid/support/v7/widget/CardViewDelegate;Landroid/content/Context;Landroid/content/res/ColorStateList;FFF)V
...
.method protected onMeasure(II)V
    ...
    instance-of v1, v0, Landroid/support/v7/widget/CardViewApi21Impl;
    ...
    invoke-interface {v0, v4}, Landroid/support/v7/widget/CardViewImpl;->getMinWidth(Landroid/support/v7/widget/CardViewDelegate;)F
    ...
    invoke-interface {v0, v2}, Landroid/support/v7/widget/CardViewImpl;->getMinHeight(Landroid/support/v7/widget/CardViewDelegate;)F

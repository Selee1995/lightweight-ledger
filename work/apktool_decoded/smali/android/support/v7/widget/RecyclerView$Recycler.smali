...
.method offsetPositionRecordsForMove(II)V
    ...
    .line 6413
    :cond_2
    invoke-virtual {v6, v0, v4}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->offsetPosition(IZ)V
...
.method recycleViewHolderInternal(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {v3, p1}, Landroid/support/v7/widget/ViewInfoStore;->removeViewHolder(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
...
.method tryGetViewHolderForPositionByDeadline(IZJ)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    .line 5857
    sget-boolean v1, Landroid/support/v7/widget/RecyclerView;->FORCE_INVALIDATE_DISPLAY_LIST:Z

    if-eqz v1, :cond_b

    .line 5858
    invoke-direct {v6, v0}, Landroid/support/v7/widget/RecyclerView$Recycler;->invalidateDisplayListInt(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    .line 5890
    invoke-virtual {v9, v0}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->hasAnyOfTheFlags(I)Z
    ...
    .line 5891
    invoke-virtual {v9, v8, v0}, Landroid/support/v7/widget/RecyclerView$ViewHolder;->setFlags(II)V
    ...
    .line 5896
    invoke-virtual {v1, v2, v9, v0, v4}, Landroid/support/v7/widget/RecyclerView$ItemAnimator;->recordPreLayoutInformation(Landroid/support/v7/widget/RecyclerView$State;Landroid/support/v7/widget/RecyclerView$ViewHolder;ILjava/util/List;)Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;
    ...
    invoke-virtual {v1, v9, v0}, Landroid/support/v7/widget/RecyclerView;->recordAnimationInfoIfBouncedHiddenView(Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    ...
    .line 5905
    iput v3, v9, Landroid/support/v7/widget/RecyclerView$ViewHolder;->mPreLayoutPosition:I
    ...
    .line 5927
    :goto_8
    iput-object v9, v1, Landroid/support/v7/widget/RecyclerView$LayoutParams;->mViewHolder:Landroid/support/v7/widget/RecyclerView$ViewHolder;

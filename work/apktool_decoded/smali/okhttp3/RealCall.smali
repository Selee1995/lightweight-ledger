...
.method getResponse(Lokhttp3/Request;Z)Lokhttp3/Response;
    ...
    .line 278
    iget-object v2, p0, Lokhttp3/RealCall;->engine:Lokhttp3/internal/http/HttpEngine;
    ...
    .line 296
    invoke-virtual {v2}, Lokhttp3/internal/http/StreamAllocation;->release()V
    ...
    .line 298
    :cond_5
    invoke-virtual {v2}, Lokhttp3/internal/http/StreamAllocation;->stream()Lokhttp3/internal/http/HttpStream;
    ...
    invoke-virtual {v4, v3, p1, v1}, Lokhttp3/internal/http/HttpEngine;->recover(Ljava/io/IOException;ZLokio/Sink;)Lokhttp3/internal/http/HttpEngine;
    ...
    invoke-virtual {v4, v5, v2, v1}, Lokhttp3/internal/http/HttpEngine;->recover(Ljava/io/IOException;ZLokio/Sink;)Lokhttp3/internal/http/HttpEngine;

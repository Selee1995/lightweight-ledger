...
.method public constructor <init>(Lokhttp3/Address;Lokhttp3/internal/RouteDatabase;)V
    ...
    invoke-direct {p0, p2, p1}, Lokhttp3/internal/http/RouteSelector;->resetNextProxy(Lokhttp3/HttpUrl;Ljava/net/Proxy;)V
...
.method private resetNextInetSocketAddress(Ljava/net/Proxy;)V
    ...
    .line 170
    iget-object p1, p0, Lokhttp3/internal/http/RouteSelector;->inetSocketAddresses:Ljava/util/List;
    ...
    .line 173
    :cond_3
    iget-object p1, p0, Lokhttp3/internal/http/RouteSelector;->address:Lokhttp3/Address;
    ...
    .line 176
    iget-object v5, p0, Lokhttp3/internal/http/RouteSelector;->inetSocketAddresses:Ljava/util/List;
    ...
    :cond_4
    :goto_3
    iput v3, p0, Lokhttp3/internal/http/RouteSelector;->nextInetSocketAddressIndex:I
...
.method private resetNextProxy(Lokhttp3/HttpUrl;Ljava/net/Proxy;)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http/RouteSelector;->proxies:Ljava/util/List;
    ...
    iput-object p2, p0, Lokhttp3/internal/http/RouteSelector;->proxies:Ljava/util/List;

    .line 118
    iget-object p2, p0, Lokhttp3/internal/http/RouteSelector;->address:Lokhttp3/Address;
    ...
    .line 119
    iget-object p2, p0, Lokhttp3/internal/http/RouteSelector;->proxies:Ljava/util/List;

    invoke-interface {p2, p1}, Ljava/util/List;->addAll(Ljava/util/Collection;)Z

    .line 121
    :cond_1
    iget-object p1, p0, Lokhttp3/internal/http/RouteSelector;->proxies:Ljava/util/List;
    ...
    .line 124
    iput p1, p0, Lokhttp3/internal/http/RouteSelector;->nextProxyIndex:I
...
.method public connectFailed(Lokhttp3/Route;Ljava/io/IOException;)V
    ...
    .line 106
    :cond_0
    iget-object p2, p0, Lokhttp3/internal/http/RouteSelector;->routeDatabase:Lokhttp3/internal/RouteDatabase;

    invoke-virtual {p2, p1}, Lokhttp3/internal/RouteDatabase;->failed(Lokhttp3/Route;)V
...
.method public next()Lokhttp3/Route;
    ...
    iget-object v3, p0, Lokhttp3/internal/http/RouteSelector;->lastProxy:Ljava/net/Proxy;
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/RouteDatabase;->shouldPostpone(Lokhttp3/Route;)Z
